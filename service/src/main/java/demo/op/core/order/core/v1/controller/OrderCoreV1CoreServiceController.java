...
public class OrderCoreV1CoreServiceController {

  private final OrderCoreV1CoreService orderCoreV1CoreService;
  ...
  public ResponseEntity<Order> createOrder(
      @ApiParam(value = "", required = true) @Validated({CreateGroup.class}) @RequestBody
          Order body) {
    Order data = orderCoreV1CoreService.createOrder(body);
    if (data != null) {
