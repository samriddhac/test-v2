...
@Component
public class AirportCoreSvcV1CoreDeleteAirportStream extends AbstractStreamSubscriber
  ...
  public AirportCoreSvcV1CoreDeleteAirportStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    airportCoreSvcV1CoreService.deleteAirport(source);
  }
