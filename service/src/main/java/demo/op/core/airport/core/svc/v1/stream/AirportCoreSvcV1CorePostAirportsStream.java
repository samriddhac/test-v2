...
@Component
public class AirportCoreSvcV1CorePostAirportsStream extends AbstractStreamSubscriber
  ...
  public AirportCoreSvcV1CorePostAirportsStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    airportCoreSvcV1CoreService.postAirports(source);
  }
