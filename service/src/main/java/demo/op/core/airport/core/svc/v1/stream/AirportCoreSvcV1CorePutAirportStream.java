...
@Component
public class AirportCoreSvcV1CorePutAirportStream extends AbstractStreamSubscriber
  ...
  public AirportCoreSvcV1CorePutAirportStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    airportCoreSvcV1CoreService.putAirport(source);
  }
