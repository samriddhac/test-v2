...
@Component
public class AirportComSvcV2CompositePutAirportStream extends AbstractStreamSubscriber
  ...
  public AirportComSvcV2CompositePutAirportStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    airportComSvcV2CompositeService.putAirport(source);
  }
