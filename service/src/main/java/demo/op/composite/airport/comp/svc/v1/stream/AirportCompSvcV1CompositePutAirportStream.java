...
@Component
public class AirportCompSvcV1CompositePutAirportStream extends AbstractStreamSubscriber
    implements ServiceContextUtil {

  @Value("${topic.subscription.putairport.name}")
  ...
  public AirportCompSvcV1CompositePutAirportStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    airportCompSvcV1CompositeService.putAirport(source);
  }
