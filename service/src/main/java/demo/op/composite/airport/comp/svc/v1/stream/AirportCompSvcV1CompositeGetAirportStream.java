...
@Component
public class AirportCompSvcV1CompositeGetAirportStream extends AbstractStreamSubscriber
  ...
  public AirportCompSvcV1CompositeGetAirportStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    airportCompSvcV1CompositeService.getAirport(source);
  }
