...
@Component
public class AirportComSvcV2CompositeDeleteAirportStream extends AbstractStreamSubscriber
  ...
  public AirportComSvcV2CompositeDeleteAirportStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    airportComSvcV2CompositeService.deleteAirport(source);
  }
