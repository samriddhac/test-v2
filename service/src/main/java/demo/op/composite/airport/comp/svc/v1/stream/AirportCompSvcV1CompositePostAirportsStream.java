...
@Component
public class AirportCompSvcV1CompositePostAirportsStream extends AbstractStreamSubscriber
  ...
  public AirportCompSvcV1CompositePostAirportsStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    airportCompSvcV1CompositeService.postAirports(source);
  }
