...
@Component
public class AirportComSvcV2CompositeGetAirportStream extends AbstractStreamSubscriber
  ...
  public AirportComSvcV2CompositeGetAirportStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    airportComSvcV2CompositeService.getAirport(source);
  }
