package demo.op.core.order.core.v1.controller;
...
import demo.op.core.order.core.v1.controller.OrderCoreV1CoreServiceController;
import demo.op.core.order.core.v1.service.OrderCoreV1CoreService;
import brave.SpanCustomizer;

@RunWith(SpringRunner.class)
@WebMvcTest(OrderCoreV1CoreServiceController.class)
public class OrderCoreV1CoreServiceControllerTest {

  @MockBean private JsonUtils jsonUtils;
  @MockBean private Logger logger;
  @Autowired private MockMvc mockMvc;
  @MockBean private OrderCoreV1CoreService orderCoreV1CoreService;
