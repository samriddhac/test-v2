...
import demo.op.core.group.core.svc.v1.controller.GroupCoreSvcV1CoreServiceController;
import demo.op.core.group.core.svc.v1.service.GroupCoreSvcV1CoreService;
import brave.SpanCustomizer;

@RunWith(SpringRunner.class)
@WebMvcTest(GroupCoreSvcV1CoreServiceController.class)
public class GroupCoreSvcV1CoreServiceControllerTest {

  @MockBean private JsonUtils jsonUtils;
  @MockBean private Logger logger;
  @Autowired private MockMvc mockMvc;
  @MockBean private GroupCoreSvcV1CoreService groupCoreSvcV1CoreService;
